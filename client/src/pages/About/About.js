  ...
  return (
    <div className="about">
      ...
      <div className="footer">
        <p>
          DISCLAIMER: This Web site is not affiliated with, endorsed, sponsored,
          or specifically approved by Wizards of the Coast LLC. This Web site
          may use the trademarks and other intellectual property of Wizards of
          the Coast LLC, which is permitted under Wizards'{" "}
          <span>
            <a href="http://dnd.wizards.com/articles/features/fan-site-kit">
              Fan Site Policy
            </a>
          </span>
          . For example, Dungeons & Dragons® is a trademark[s] of Wizards of the
          ...
          website at{" "}
          <span>
            <a href="http://wizards.com">wizards.com</a>
          </span>
          .
        </p>
        <h3>
